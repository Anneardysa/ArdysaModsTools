...
{
    /// <summary>
    /// Tests for AssetHashManifestService — manifest parsing and graceful lookup behavior.
    /// </summary>
    [TestFixture]
    public class AssetHashManifestServiceTests
    {
        ...
        {
            // Reset the singleton cache so tests don't leak manifest state into each other.
