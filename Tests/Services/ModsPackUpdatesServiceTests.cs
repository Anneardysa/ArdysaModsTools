...
{
    /// <summary>
    /// Tests for <see cref="ModsPackUpdatesService.Parse"/> — the pure parsing seam of the ModsPack
    /// updates fetcher (the network path uses a static HttpClient and is not unit-tested here).
    /// </summary>
    [TestFixture]
