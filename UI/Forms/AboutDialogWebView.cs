...
{
    /// <summary>
    /// WebView2-hosted "About" dialog. Renders a minimalist identity + Credits &amp; Acknowledgments
    /// panel styled to match <c>main_shell</c>. Self-contained: it pushes the app version to
    /// <c>about.html</c> once the page is ready. Static content only (no network dependency).
    /// </summary>
    public sealed class AboutDialogWebView : Form
    {
        ...
        private async Task InitializeAsync()
        {
            ...
            {
                // Without WebView2 there is no native fallback view; open the repo instead.
        ...
        // [AMT:PRO] Bridge push — paired with setVersion(...) in Assets/Html/about.html.
        ...
        // [AMT:PRO] JS↔C# bridge — message 'type' strings are a contract with about.html.
