...
namespace ArdysaModsTools.Core.Services
{
    public class DetectionService : IDetectionService
    {
        ...
        public string? ManualDetect(string? initialPath = null)
        {
            using var folderBrowser = new FolderBrowserDialog
            {
                Description = Loc.T("detect.folderBrowse.desc")
            };
            ...
            if (folderBrowser.ShowDialog() == DialogResult.OK)
            {
                ...
                MessageBox.Show(Loc.T("detect.invalid.body"), Loc.T("detect.invalid.title"), MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
