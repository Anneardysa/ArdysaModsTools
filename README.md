...
| **Skin & Persona Selector** | Browse hero sets, individual item pieces (with slot-based mutual exclusion), and full Personas via an interactive gallery. |
...
2. Filter by hero or category (Legacy, Custom, Persona, Item, Base), or search by name.
...
5. Click **Generate** to compile and apply your custom patch.
